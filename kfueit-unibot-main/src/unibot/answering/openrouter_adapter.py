...
_CITATION_ANSWER_SCHEMA = {
    ...
    "properties": {
        "status": {
            ...
            "description": "Whether the query was answered or abstained.",
        },
        "answer_text": {
            "type": "string",
            "description": (
                "The full answer in Markdown (headings, bold, bullets) "
                "with inline citation markers such as [1]."
            ),
        },
        "claims": {
            "type": "array",
            "items": {
                ...
                "properties": {
                    "text": {
                        "type": "string",
                        "description": "A single material claim from the answer.",
                    },
                    "citation_ids": {
                        "type": "array",
                        "items": {"type": "string"},
                        "description": "Evidence block IDs supporting this claim, e.g. ['[1]'].",
                    },
                },
                "additionalProperties": False,
            },
            "description": "List of material claims, each backed by citation IDs.",
        },
        "warnings": {
            "type": "array",
            "items": {"type": "string"},
            "description": "Any caveats or warnings about the answer.",
        },
    },
    "additionalProperties": False,
}
